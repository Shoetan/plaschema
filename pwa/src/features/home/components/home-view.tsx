...
export function HomeView() {
  ...
  return <div className="space-y-5 px-4 py-6">
    ...
    <Link to="/enroll-household" className="primary-button flex w-full items-center justify-center gap-2"><Plus size={20} />Enroll new Household</Link>
    ...
    <Link to="/households" className="secondary-button flex w-full items-center justify-center gap-2 text-sm"><UsersRound size={17} />Add household member</Link>
