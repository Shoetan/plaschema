import { ArrowLeft, FileText, MapPin, Phone, RefreshCw, Trash2, UserRound } from 'lucide-react'
import { Link, useNavigate } from 'react-router-dom'

import { StatusBadge } from '@/components/status-badge'
import { useEnrollmentSync, useLocalEnrollment } from '@/features/enrollment/hooks'
import { discardLocalEnrollment, retryLocalEnrollment } from '@/features/enrollment/services'
...
export function BeneficiaryDetailView({ beneficiaryId }: { beneficiaryId: string }) {
  ...
  const sections = [
    ...
    { title: 'Contact', icon: Phone, rows: [['Phone', form.phone], ['Email', form.email || '—'], ['Emergency contact', form.emergencyPhone || '—']] },
